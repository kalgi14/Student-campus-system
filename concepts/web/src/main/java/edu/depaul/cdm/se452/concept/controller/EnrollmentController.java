...
import edu.depaul.cdm.se452.concept.model.IEnrollmentService;
import edu.depaul.cdm.se452.concept.model.enrollmentService;

import javax.validation.Valid;

import edu.depaul.cdm.se452.concept.model.userCredentials;
...
public class EnrollmentController {
    ...
    public ModelAndView test() {
        ModelAndView mv = new ModelAndView("admin/list-students");
        List<userLogin> a = usrCred.JPQLQuery();
        mv.addObject("test", a.iterator());
        return mv;
    }
}
